        ...
        return (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Choose the categories you want to monitor</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
        ...
        return (
          <Card>
            <CardHeader>
              ...
              <CardDescription>Optionally set screen time reduction goals</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
              <div className="flex items-center space-x-2">
                <Switch id="set-goals" checked={setGoals} onCheckedChange={setSetGoals} />
                <Label htmlFor="set-goals">Set screen time reduction goals</Label>
              </div>
              {setGoals && (
                <>
                    ...
                    {selectedHabits.map((habit) => (
                      <div key={habit} className="flex items-center space-x-2">
                        ...
                        <Input
                          ...
                          onChange={(e) => setDailyLimit({ ...dailyLimit, [habit]: Number(e.target.value) })}
                        />
                      </div>
                    ))}
                  </div>
                  <div className="space-y-2">
                    ...
                    <RadioGroup value={reductionTarget} onValueChange={setReductionTarget}>
                      <div className="flex items-center space-x-2">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="flex items-center space-x-2">
                      <Input
                        ...
                        onChange={(e) => setFocusHours({ ...focusHours, start: e.target.value })}
                      />
                      <span>to</span>
                      <Input
                        type="time"
                        value={focusHours.end}
                        onChange={(e) => setFocusHours({ ...focusHours, end: e.target.value })}
                      />
                    </div>
                  </div>
                </>
