...
export function QuickStats({ appsBlocked, timeSaved, bestStreak, averageStreak, daysSinceLastSlip }: QuickStatsProps) {
  return (
    <Card>
      <CardHeader>
      ...
      <CardContent>
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="text-2xl font-bold">{averageStreak.toFixed(1)} days</p>
          </div>
